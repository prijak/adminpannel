    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true"
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a href="adminindex.php"><i class="ft-home"></i><span class="menu-title"
                ...
                <li class=" active"><a href="banners.php"><i class="ft-droplet"></i><span class="menu-title"
                                            ...
                                            <form action="bannermodify.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control"
                                                            placeholder="Heading of banner" required="true"
                                                            id="basicInput" name="Heading" name="Heading"></td>
                                                ...
                                                <tr>
                                                    <th> Sub Heading</th>
                                                    <td><input type="text" class="form-control"
                                                            placeholder="Sub heading of Banner" required="true"
                                                            id="basicInput" name="subHeading"></td>
                                                ...
                                                <td colspan="2">
                                                    <center><button type="submit"
                                                            class="btn btn-success btn-min-width mr-1 mb-1">Submit</button>
                                                    </center>
                                                </td>
                                            </form>
                                        </tbody>
                                            ...
                                            <form action="bannermodify.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button type="Submit"
                                                            class="btn btn-danger  btn-min-width mr-1 mb-1" name="pid"
                                                            value="<?php echo $row['ID']; ?>">Delete Banner</button>
                                                    </td>
                                    ...
                                    <tbody>
                                        ...
                                        <form action="bannermodify.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <tr>
                                                ...
                                                <th>Main Heading</th>
                                                <td><input type="text" class="form-control"
                                                        value="<?php echo $row['MainHeading'] ?>" required="true"
                                                        id="basicInput" name="Heading"></td>
                                            ...
                                            <tr>
                                                <th> Sub Heading</th>
                                                <td><input type="text" class="form-control"
                                                        value="<?php echo $row['SubHeading'] ?>" required="true"
                                                        id="basicInput" name="subHeading"></td>
                                            ...
                                            <tr>
                                                <th> Image </th>
                                                <td><img height="130" width="330" class=""
                                                        src="theme-assets/images/<?php echo $row['Image']; ?>"
                                                        alt="<?php echo $row['file_name']; ?>"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <center><button type="submit"
                                                            class="btn btn-success btn-min-width mr-1 mb-1" name="pid"
                                                            value="<?php echo $row['ID']; ?>">Submit</button></center>
                                                </td>
                                ...
                                <tbody>
                                    ...
                                    <form action="bannermodify.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" placeholder="Vlog Description"
                                                    required="true" id="basicInput" name="Heading"></td>


                                        </tr>
                                        <tr>
                                            <th> Vlogger Name</th>
                                            <td><input type="text" class="form-control" placeholder="Vlogger Name"
                                                    required="true" id="basicInput" name="subHeading"></td>

                                        </tr>
                                        <tr>
                                            <th> Vlog Link</th>
                                            <td><input type="text" class="form-control" placeholder="Vlog Link"
                                                    required="true" id="basicInput" name="link"></td>
                                ...
                                <tbody>
                                    ...
                                    <form action="bannermodify.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <tr>
                                            ...
                                            <td><button type="Submit" class="btn btn-danger  btn-min-width mr-1 mb-1"
                                                    name="pid" value="<?php echo $row['ID']; ?>">Delete Banner</button>
                                            </td>
                            ...
                            <tbody>
                                ...
                                <form action="bannermodify.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <tr>
                                        <th> Vlogger Name</th>
                                        <td><input type="text" class="form-control"
                                                value="<?php echo $row['SubHeading'] ?>" required="true" id="basicInput"
                                                name="subHeading"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img height="130" width="330" class=""
                                                src="theme-assets/images/<?php echo $row['Image']; ?>"
                                                alt="<?php echo $row['file_name']; ?>"> &nbsp &nbsp &nbsp &nbsp <button
                                                type="button" class="btn btn-danger  btn-min-width mr-1 mb-1" name="oof"
                                                value="<?php echo $row['Product_ID']; ?>"
                                                onClick="document.location.href='remimg.php?oof=<?php echo $row1['id']; ?>'">
                                    ...
                                    <tr>
                                        <th> Vlog Link</th>
                                        <td><input type="text" class="form-control"
                                                value="<?php echo $row['VlogLink'] ?>" required="true" id="basicInput"
                                                name="link"></td>
                                    ...
                                    <td colspan="2">
                                        <center><button type="submit" class="btn btn-success btn-min-width mr-1 mb-1"
                                                name="pid" value="<?php echo $row['ID']; ?>">Submit</button></center>
                                    </td>
                        ...
                        <tbody>
                            ...
                            <form action="bannermodify.php" method="post" enctype="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <th>Main Heading</th>
                                    <td><input type="text" class="form-control"
                                            value="<?php echo $row['MainHeading'] ?>" required="true" id="basicInput"
                                            name="Heading"></td>
                                ...
                                <tr>
                                    <th> Sub Heading </th>
                                    <td><input type="text" class="form-control" value="<?php echo $row['SubHeading'] ?>"
                                            required="true" id="basicInput" name="subHeading"></td>
