                                    ...
                                    ?>
                                        <form action="editfrontitem.php" method="post">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" value="<?php echo $row1['Product_name']; ?>"
                                                        readonly="readonly" id="basicInput" name="pname"></td>
                                                <td><img height="130" width="130" class=""
                                                        src="theme-assets/images/<?php echo $row1['Image1']; ?>"
                                                        alt="Error With Image"></td>
                                                <td><input type="text" class="form-control" value="<?php echo $row1['Product_ID']; ?>" id="basicInput"
                                                        name="PID"></td>
                                                <td> <button type="submit"
                                                        class="btn btn-success btn-min-width mr-1 mb-1"
                                                        name="frontItemtoedit" value="<?php echo $whattodo; ?>">Submit</button> </td>
